...
// {
//   _id: ObjectId,
//   type: "non-emergency" | "time-sensitive" | "medical-emergency",
//   room: String,
//   title: String,
//   description: String,
//   status: "pending" | "in-progress" | "completed" | "outstanding",
//   assignedTo: ObjectId | null,
//   submittedAt: Date,
//   completedAt: Date | null,
//   highlighted: Boolean,       ← admin flag
//   pingedAt: Date | null       ← last time admin pinged staff
// }
...
router.post("/", async (req, res) => {
    try {
        const db = getDb();
        const { type, room, title, description, assignedTo, assignedRole } = req.body;
        if (!type || !room || !title)
...
// PATCH /api/tasks/:id — update any task fields (status, assignedTo, etc.)
...
// PATCH /api/tasks/:id/highlight — admin toggles flag on a task
...
// PATCH /api/tasks/:id/ping — admin pings staff assigned to a task
