...
// Uses the same native MongoDB driver pattern as the rest of the server.
//
// Room document shape:
// {
//   _id: ObjectId,
...
// POST /api/rooms/seed — populate default rooms (run once)
...
// GET /api/rooms — get all rooms, optional ?floor= and ?status= filters
...
// PATCH /api/rooms/:id — update bed data, auto-derives status
